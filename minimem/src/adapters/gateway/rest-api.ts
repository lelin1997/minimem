...
import { countWorldFacts, listWorldFacts } from '../../infra/store/world-facts.js';
import { countObservations, listObservations } from '../../infra/store/observations.js';
import { countMentalModels, listMentalModels, getActiveMentalModels } from '../../infra/store/mental-models.js';
import { countKnowledgePages } from '../../infra/store/knowledge-pages/page-store.js';
import { getKnowledgePageById, listKnowledgePages, deleteOrArchiveKnowledgePage, getAllKnowledgeTags } from '../../infra/store/knowledge-pages/index.js';
...
export function createRestApp(): Hono {
  ...
  app.get('/api/v1/metrics', async (c) => {
    const { collectMetrics } = await import('../../infra/observability/metrics.js');
